(function(exports, global) {
    ...
    "use strict";
    angular.module("facebookUtils").service("facebookUser", [ "$window", "$rootScope", "$q", "facebookConfigDefaults", "facebookConfigSettings", "facebookSDK","$timeout", function($window, $rootScope, $q, facebookConfigDefaults, facebookConfigSettings, facebookSDK,$timeout) {
