...
class catchAll:
    def GET(self, user):
        try:
            ...
            outputObj = {"Error": "No API endpoint found. Try navigating to " + droneAPIUtils.homeDomain + "/vehicle for list of vehicles or to " + droneAPIUtils.homeDomain +
                         "/vehicle/<vehicleId> for the status of vehicle #1 or to " + droneAPIUtils.homeDomain + "/vehicle/<vehicleId>/action for the list of actions available for vehicle <vehicleId>."}
