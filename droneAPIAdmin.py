...
import logging, traceback, json, redis
...
class admin:        
    def GET(self):
        try:
            ...
            outputObj={}
            outputObj['_links']={"self":{"href": droneAPIUtils.homeDomain + "/admin", "title":"Administration functions for the Drone API service"}}
            ...
            for key in keys:
                ...
                outputObj['Connections'].append({"connectionString":connectionString, "dockerContainerId":dockerContainerId,"vehicleName":vehicleName,"vehicleType":vehicleType,"droneId":droneId,"hostIp":hostIp,"port":port})
