...
sleep 3
docker ps -a | awk '{ print $1,$2 }' | grep droneapiworker | awk '{print $1 }' | xargs -I {} docker  exec -t -i {} cat droneapi.log
docker ps -a | awk '{ print $1,$2 }' | grep droneapiworker | awk '{print $1 }' | xargs -I {} docker  exec -t -i {} tail -f droneapi.log
